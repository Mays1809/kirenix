...
**Где брать VPS (РФ):** Timeweb Cloud, Selectel, Aeza, RuVDS — любой. Бери Россию,
Ubuntu, минимальный тариф (1 CPU / 1 ГБ хватит с запасом). Запиши **IP-адрес** сервера
и пароль root (или добавь SSH-ключ).
