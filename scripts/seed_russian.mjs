// ═══════════════════════════════════════════════════════════════════
//  Загрузка курса «Русский язык ЕГЭ 2026» в Supabase (модули + уроки).
//
...
const dir  = join(here, "..", "src", "courses", "russian");

const MODULES = [
  { num: 1, icon: "📖", title: "Работа с текстом",        file: "m01_tekst_mikrotekst.md" },
  { num: 2, icon: "🗣️", title: "Лексика и орфоэпия",      file: "m02_leksika_orfoepiya.md" },
  { num: 3, icon: "🧩", title: "Грамматические нормы",     file: "m03_grammaticheskie_normy.md" },
  { num: 4, icon: "✏️", title: "Орфография",               file: "m04_orfografiya.md" },
  { num: 5, icon: "❓", title: "Пунктуация",               file: "m05_punktuaciya.md" },
  { num: 6, icon: "🔍", title: "Анализ текста",            file: "m06_analiz_teksta.md" },
  { num: 7, icon: "✍️", title: "Сочинение (задание 27)",   file: "m07_sochinenie.md" },
  { num: 8, icon: "🏁", title: "Финальная подготовка",     file: "m08_finalnaya.md" },
];
